...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item  active" href="table-data-banned.php"><i class='app-menu__icon bx bx-run'></i><span
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <a class="btn btn-cancel" href="/doc/table-data-banned.php">Hủy bỏ</a>
        </div>
    </main>
