    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            <form class="row" action="addpr.php" method="post">
              <div class="form-group col-md-3">
                <label class="control-label">Mã sản phẩm </label>
                <input class="form-control" name="masanpham" type="text">
              </div>
              <div class="form-group col-md-3">
              ...
              <button class="btn btn-save" type="submit" name="btn-save" style="margin-left: 15px ;">Lưu lại</button>
            </form>
          </div>
        </div>
