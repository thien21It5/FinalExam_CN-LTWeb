...
//Sweater
$sql2 = "SELECT * FROM `donhang` WHERE tinhtrang = 'Còn hàng' AND danhmuc = 'Sweater'";
...
//áo phao
$sql3 = "SELECT * FROM `donhang` WHERE tinhtrang = 'Còn hàng' AND danhmuc = 'Áo phao'";
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="site/view/pages/about.php" <?php if ($_SERVER['SCRIPT_NAME'] == "/hexashop-1.0.0/pages/about.php") echo 'class="active"'; ?>>About Us</a></li>
                            <li><a href="site/view/pages/products.php" <?php if ($_SERVER['SCRIPT_NAME'] == "/hexashop-1.0.0/pages/products.php") echo 'class="active"'; ?>>Products</a></li>
                            <li><a href="site/view/pages/contact.php" <?php if ($_SERVER['SCRIPT_NAME'] == "/hexashop-1.0.0/pages/contact.php") echo 'class="active"'; ?>>Contact Us</a></li>
                            <?php
                            ob_start();
                            if (!isset($_SESSION["is_login"])) {
                                require 'site/controller/inc/loginmenu2.php';
                            } else {
                                if ($_SESSION["is_login"] == true) {
                                    require 'site/controller/inc/acpgiohang2.php';
                                    require 'site/controller/inc/logout2.php';
                                }
                            }
                            ?>
                        </ul>
                        ...
                        <div class="thumb">
                            <div class="inner-content">
                                ...
                                <div class="main-border-button">
                                    <a href="site/view/pasges/products.php">Purchase Now!</a>
                                </div>
                            </div>
                                    ...
                                    <div class="thumb">
                                        ...
                                        <div class="hover-content">
                                            <div class="inner">
                                                ...
                                                <div class="main-border-button">
                                                    <a href="site/view/pasges/products.php">Discover More</a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="public/assets/images/everyone.png">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                ?>
                                    <div class="item">
                                        <div class="thumb">
                                            <div class="hover-content">
                                                <ul>
                                                    <li><a href="site/view/pasges/single-product.php?id=<?php echo $item['masanpham'] ?>"><i class="fa fa-shopping-cart"></i></a></li>
                                                </ul>
                                            </div>
                ...
                <div class="col-lg-12">
                    <div class="women-item-carousel">
                        <div class="owl-women-item owl-carousel">
                            <?php
                            if (!empty($list_donhang2)) {
                            ?>
                                <?php foreach ($list_donhang2 as $item) {
                                ?>
                                    <div class="item">
                                        <div class="thumb">
                                            <div class="hover-content">
